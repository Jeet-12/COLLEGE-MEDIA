...
$unlike_btn_display='';
    ...
    ?>
                ...
                <i class="bi bi-heart like_btn" id="mush" style="display:<?=$like_btn_display?>" data-post-id='<?=$post['id']?>'></i>
...
if(count($follow_suggestions)<1){
    echo "<p class='p-2 bg-white border rounded text-center'>No Suggestions For You</p>";
        ...
        <audio controls id="m">
                        <source src="..//COLLEGE MEDIA//jeet.mp3" type="audio/mpeg">
                    </audio>
    </div>
    <script>
        document.getElementById("m").style.display = "none";
        document.getElementById("mush").onclick = function(){
